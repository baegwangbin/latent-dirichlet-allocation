...
title('Mixing Proportions vs Gibbs Iteration', 'FontSize', 20, 'FontWeight', 'bold');
...
%The following command plots the mixing proportions of each component

%for i = 1:100
%    plot(theta(:,i), 'Linewidth', 1, 'Color', [1-i/20 0 i/20]);
%    hold on;
%end
...
%title('Mixing Proportions of each Component', 'FontSize', 20, 'FontWeight', 'bold');
%xlabel('Mixture Component', 'FontSize', 15, 'FontWeight', 'bold');
%ylabel('Posterior Probabilities', 'FontSize', 15, 'FontWeight', 'bold');